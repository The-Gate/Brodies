$(document).ready(function(){
  ...
  if($('#content .middle h1').height() > titleHeight){
   ...
   $('#content > .left,#content > .right').css({'padding-top':($('#content .middle h1').height()-titleHeight)+'px'})
 }
  }
  ...
  if($('#block-views-Related_Video-block_1 .field-content > .field-item').length == 0){
    $('#block-views-Related_Video-block_1').css({
      'display':'none'
    });
    
  } else {
    $('#block-views-Related_Video-block_1 .field-content > .field-item').addClass('hide');
    // add the video pop[ up to the related videos
    $('#block-views-Related_Video-block_1 .field-content > .field-item').each(function(){
  ...
  if($('#block-views-Case_Studies-block_1 .field-content > .field-item').length == 0){
    $('#block-views-Case_Studies-block_1').css({
      'display':'none'
    });
  } else {
    $('#block-views-Case_Studies-block_1 .field-content > .field-item').addClass('hide');
  }
  ...
  $('#block-views-Related_Video-block_1 label').click(function(e){
    ...
    $('#block-views-Related_Video-block_1 .field-content > .field-item').removeClass('hide');
    $('#block-views-Case_Studies-block_1 .field-content > .field-item').addClass('hide');
  });
  $('#block-views-Case_Studies-block_1 label').click(function(e){
    ...
    $('#block-views-Key_Contacts-block_1 .field-content > .field-item').addClass('hide');
    $('#block-views-Related_Video-block_1 .field-content > .field-item').addClass('hide');
    $('#block-views-Case_Studies-block_1 .field-content > .field-item').removeClass('hide');
  });
