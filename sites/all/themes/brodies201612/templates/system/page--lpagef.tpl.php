        ...
        <section<?php print $content_column_class; ?>>
            ...
            <div class="is-table-row">
                ...
                if (isset($node->field_lp_blk_1[LANGUAGE_NONE][0]['value'])):
                  ...
                  ?>
                  <div class="col-md-3"><div class="col" <?= $col1 ?>><?= $node->field_lp_blk_1[LANGUAGE_NONE][0]['value']; ?></div></div>
                <?php endif; ?>
                <?php
                //////  block 2
                if (isset($node->field_lp_blk_2[LANGUAGE_NONE][0]['value'])):
                  ...
                  ?>
                  <div class="col-md-3"><div class="col" <?= $col2 ?>><?= $node->field_lp_blk_2[LANGUAGE_NONE][0]['value']; ?></div></div>
                <?php endif; ?>
                <?php
                //////  block 3
                if (isset($node->field_lp_blk_3[LANGUAGE_NONE][0]['value'])):
                  ...
                  ?>
                  <div class="col-md-3"><div class="col" <?= $col3 ?>><?= $node->field_lp_blk_3[LANGUAGE_NONE][0]['value']; ?></div></div>
                <?php endif; ?>
                <?php
                //////  block 4
                if (isset($node->field_lp_blk_4[LANGUAGE_NONE][0]['value'])):
                  ...
                  ?>
                  <div class="col-md-3"><div class="col" <?= $col4 ?>><?= $node->field_lp_blk_4[LANGUAGE_NONE][0]['value']; ?></div></div>
                <?php endif; ?>
            </div>
        </section>
