 ...
 */
$teaser_out = '';
if (isset($row->field_field_service_teaser)) {
  $teaser_out = $view->render_field("field_service_teaser", $view->row_index);
}
elseif (isset($row->field_field_sector_teaser)) {
  $teaser_out = $view->render_field("field_sector_teaser", $view->row_index);
}
?>
<?php foreach ($fields as $id => $field): ?>
  ...
  <div class="item-wrapper"><div class="item" <?php print $style; ?>>
          ...
          <span class="teaser"><?php print $teaser_out; ?></span>
