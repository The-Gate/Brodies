...
class Woo_Widget_Component extends WP_Widget {
	...
	function Woo_Widget_Component () {
		...
		$this->woo_widget_componentslist = array(
												'featured' => __( 'Featured Slider', 'woothemes' ), 
												'recent-entries' => __( 'Recent Entries', 'woothemes' ), 
												'specific-entries' => __( 'Specific Entries', 'woothemes' ), 
												'categories-grid' => __( 'Categories Grid', 'woothemes' )
												);
