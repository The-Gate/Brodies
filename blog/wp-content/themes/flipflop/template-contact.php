                        ...
                        <section class="entry">
                			...
                			<div class="location-twitter fix">
						    	...
						    	<section id="office-location" class="col-left">
									<?php if ( isset( $woo_options['woo_contact_title'] ) && ( '' != $woo_options['woo_contact_title'] ) ) { ?><h3><?php echo $woo_options['woo_contact_title']; ?></h3><?php } ?>
									<ul>
										<?php if ( isset( $woo_options['woo_contact_address'] ) && ( '' != $woo_options['woo_contact_address'] ) ) { ?><li><?php echo $woo_options['woo_contact_address']; ?></li><?php } ?>
										...
										<?php if ( isset( $woo_options['woo_contact_email'] ) && ( '' != $woo_options['woo_contact_email'] ) && is_email( $woo_options['woo_contact_email'] ) ) { ?><li><?php _e( 'Email:', 'woothemes' ); ?> <a href="mailto:<?php echo esc_attr( $woo_options['woo_contact_email'] ); ?>"><?php echo $woo_options['woo_contact_email']; ?></a></li><?php } ?>
									</ul>
						    	</section>
						    	...
						    	<div class="contact-social col-right">
						    		...
						    		<section id="twitter">
						    			<h3><?php _e( 'Twitter', 'woothemes' ); ?></h3>
						    			<ul id="twitter_update_list_123"><li></li></ul>
						    			<?php echo woo_twitter_script( 123, esc_attr( $woo_options['woo_contact_twitter'] ), 1 ); ?>
						    		</section>
						    		<?php } ?>
