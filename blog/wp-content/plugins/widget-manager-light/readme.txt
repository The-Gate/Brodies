...
[Demo site](http://otwthemes.com/demos/1ts/?item=Sidebar%20Widget%20Manager&utm_source=wp.org&utm_medium=page&utm_content=upgrade&utm_campaign=wml) | [Create responsive layouts in minutes, drag & drop interface, feature rich](http://otwthemes.com/widgetizing-pages-in-wordpress-can-be-even-easier-and-faster?utm_source=wp.org&utm_medium=page&utm_content=site&utm_campaign=wml)
...
Please refer to [online documentation page](http://otwthemes.com/online-documentation-widget-manager-light/?utm_source=wp.org&utm_medium=page&utm_content=docs&utm_campaign=wml) for more details and screenshots.
...
* Added: All posts from category/tag except some post ids option
...
* Added: All posts from tag filter
* Added: All posts from custom taxonomy filter
